...
const hostingPlans: { title: string; href: string; description: string }[] = [
  {
    title: "Web hosting",
    href: "/hosting",
    description:
      "Powerful web hosting with free SSL and backups included.",
  },
  {
  ...
  },
  {
    ...
    description: "Fully white-label hosting with cPanel to run your hosting business.",
  }
];
          ...
          <NavigationMenu>
            <ul className="items-center hidden space-x-8 lg:flex">
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-4 grid-rows-3 lg:w-[700px]">
